    ...
    return new Vuex.Store({
        ...
        actions:{
            ...
            nuxtServerInit(vuexContext,context){
                return axios.get("https://hp-up-bc8ae-default-rtdb.firebaseio.com/posts.json")
                .then(res=>{
                    const data=[];
            ...
            addPost(vuexContext,post){
                ...
                return axios.
                    post("https://hp-up-bc8ae-default-rtdb.firebaseio.com/posts.json",createPost)
                    .then(res=>{
            ...
            editPost(vuexContext,post){
                return axios.
                    put("https://hp-up-bc8ae-default-rtdb.firebaseio.com/posts/"+post.id+".json",post)
                    .then(res=>{
                        // commit mutation
